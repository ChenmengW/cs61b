...
public class Editor extends Application {
    ...
    private LinkedList<String> inputCharacters = new LinkedList<String>();
...
//            textCenterY = windowHeight / 2;
        ...
        public void setDisplayText(LinkedList<String> chars) {
            String text = String.join("", inputCharacters);
        ...
        public void handle(KeyEvent keyEvent) {
            if (keyEvent.getEventType() == KeyEvent.KEY_TYPED) {
                ...
                if (characterTyped.length() > 0 && characterTyped.charAt(0) != 8) {
                    ...
                    inputCharacters.add(characterTyped);
                    setDisplayText(inputCharacters);
                    keyEvent.consume();
                } else if (characterTyped.length() > 0 && characterTyped.charAt(0) == 8) {
                    inputCharacters.removeLast();
                    setDisplayText(inputCharacters);
                }
...
//            double textTop = textHeight / 2;
//            double textLeft = textWidth / 2;
